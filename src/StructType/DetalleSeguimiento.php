...
/**
 * This class stands for detalleSeguimiento StructType
 * @subpackage Structs
 */
class DetalleSeguimiento extends AbstractStructBase
{
    /**
     * The cantidadBultos
     * @var int|null
    ...
    /**
     * Constructor method for detalleSeguimiento
     * @uses DetalleSeguimiento::setCantidadBultos()
     * @uses DetalleSeguimiento::setCantidadKilos()
     * @uses DetalleSeguimiento::setCiudadDestino()
     * @uses DetalleSeguimiento::setCiudadOrigen()
     * @uses DetalleSeguimiento::setCodigoEstadoHomologado()
     * @uses DetalleSeguimiento::setCuentaCorriente()
     * @uses DetalleSeguimiento::setDescEstadoHomologado()
     * @uses DetalleSeguimiento::setDocumentoCliente()
     * @uses DetalleSeguimiento::setEstadoFlete()
     * @uses DetalleSeguimiento::setEstadoHomologado()
     * @uses DetalleSeguimiento::setFechaCompromiso()
     * @uses DetalleSeguimiento::setFechaEmision()
     * @uses DetalleSeguimiento::setFechaEntrega()
     * @uses DetalleSeguimiento::setNombreDestinatario()
     * @uses DetalleSeguimiento::setNombreRemitente()
     * @uses DetalleSeguimiento::setNombreRetira()
     * @uses DetalleSeguimiento::setOrdenFlete()
     * @uses DetalleSeguimiento::setRutRetira()
     * @uses DetalleSeguimiento::setTipoEntrega()
     * @uses DetalleSeguimiento::setTipoServicio()
     * @uses DetalleSeguimiento::setValorFlete()
     ...
     * @param int $cantidadBultos
     * @return \StructType\DetalleSeguimiento
     */
