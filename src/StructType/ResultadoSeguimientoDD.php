...
/**
 * This class stands for resultadoSeguimientoDD StructType
 * @subpackage Structs
 */
class ResultadoSeguimientoDD extends AbstractStructBase
{
    /**
     ...
     * @var string|null
     */
    protected ?string $urlDocumento = null;
    /**
     * Constructor method for resultadoSeguimientoDD
     * @uses ResultadoSeguimientoDD::setCodigoEstadoHomologado()
     * @uses ResultadoSeguimientoDD::setDctoCliente()
     * @uses ResultadoSeguimientoDD::setDescEstadoHomologado()
     * @uses ResultadoSeguimientoDD::setDestino()
     * @uses ResultadoSeguimientoDD::setEstado()
     * @uses ResultadoSeguimientoDD::setEstadoHomologado()
     * @uses ResultadoSeguimientoDD::setFechaEmision()
     * @uses ResultadoSeguimientoDD::setFechaHoraEntrega()
     * @uses ResultadoSeguimientoDD::setNroOrdenFlete()
     * @uses ResultadoSeguimientoDD::setOrigen()
     * @uses ResultadoSeguimientoDD::setUrlDocumento()
     ...
     */
    public function __construct(?int $codigoEstadoHomologado = null, ?int $dctoCliente = null, ?string $descEstadoHomologado = null, ?string $destino = null, ?string $estado = null, ?string $estadoHomologado = null, ?string $fechaEmision = null, ?string $fechaHoraEntrega = null, ?int $nroOrdenFlete = null, ?string $origen = null, ?string $urlDocumento = null)
    {
        $this
     ...
     * @return \StructType\ResultadoSeguimientoDD
     */
    public function setUrlDocumento(?string $urlDocumento = null): self
    {
        // validation for constraint: string
        if (!is_null($urlDocumento) && !is_string($urlDocumento)) {
            throw new InvalidArgumentException(sprintf('Invalid value %s, please provide a string, %s given', var_export($urlDocumento, true), gettype($urlDocumento)), __LINE__);
        }
